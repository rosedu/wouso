...
upat = [
    ...
    url(r'^races/add/$', 'wouso.interface.cpanel.views.races_add',
        name='races_add'),
    url(r'^races/update/(?P<pk>\d+)/$', 'wouso.interface.cpanel.views.races_update', name='races_update'),
    url(r'^races/groups/add/$', 'wouso.interface.cpanel.views.group_add',
        name='group_add'),
    url(r'^races/groups/update/(?P<pk>\d+)/$','wouso.interface.cpanel.views.group_update', name='group_update'),
