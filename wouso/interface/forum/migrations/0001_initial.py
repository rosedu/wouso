...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('forum_topic', (
            ...
            ('last_post', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forum_last_post', null=True, to=orm['forum.Post'])),
        ))
        ...
        db.create_table('forum_post', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.ForumUser'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('indentation', self.gf('django.db.models.fields.IntegerField')(default=0)),
