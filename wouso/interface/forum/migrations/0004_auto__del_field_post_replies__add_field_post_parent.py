...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.replies'
        db.delete_column('forum_post', 'replies_id')

        # Adding field 'Post.parent'
        db.add_column('forum_post', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='replies', null=True, to=orm['forum.Post']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Post.replies'
        db.add_column('forum_post', 'replies',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Post'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Post.parent'
        db.delete_column('forum_post', 'parent_id')
    ...
    models = {
        ...
        'forum.post': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'replies'", 'null': 'True', 'to': "orm['forum.Post']"}),
