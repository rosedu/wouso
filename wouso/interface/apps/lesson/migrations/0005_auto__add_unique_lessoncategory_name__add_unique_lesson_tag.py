...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('lesson_lessoncategory', ['name'])

        # Adding unique constraint on 'Lesson', fields ['tag']
        db.create_unique('lesson_lesson', ['tag_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Lesson', fields ['tag']
        db.delete_unique('lesson_lesson', ['tag_id'])

        # Removing unique constraint on 'LessonCategory', fields ['name']
        db.delete_unique('lesson_lessoncategory', ['name'])
    ...
    models = {
        ...
        'lesson.lesson': {
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lessons'", 'unique': 'True', 'null': 'True', 'to': "orm['lesson.LessonTag']"}),
