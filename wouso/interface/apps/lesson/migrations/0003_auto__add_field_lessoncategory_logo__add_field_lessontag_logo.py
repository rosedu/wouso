...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LessonCategory.logo'
        db.add_column('lesson_lessoncategory', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LessonTag.logo'
        db.add_column('lesson_lessontag', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LessonCategory.logo'
        db.delete_column('lesson_lessoncategory', 'logo')

        # Deleting field 'LessonTag.logo'
        db.delete_column('lesson_lessontag', 'logo')
