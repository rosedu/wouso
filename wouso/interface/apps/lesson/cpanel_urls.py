...
urlpatterns = patterns('wouso.interface.apps.lesson.cpanel_views',
    ...
    url(r'^add_category/$', 'add_category', name='add_files_category'),
    url(r'^edit_category/(?P<pk>\d+)/$', 'edit_category', name='edit_files_category'),
    url(r'^delete_category/(?P<pk>\d+)/$', 'delete_category', name='delete_files_category'),
