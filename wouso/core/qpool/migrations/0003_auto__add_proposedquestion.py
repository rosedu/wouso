...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProposedQuestion'
        db.create_table('qpool_proposedquestion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
            ('proposed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='qpool_proposedquestion_proposedby_related', null=True, to=orm['auth.User'])),
            ...
            ('answers', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
        ))
        db.send_create_signal('qpool', ['ProposedQuestion'])

        # Adding M2M table for field tags on 'ProposedQuestion'
        m2m_table_name = db.shorten_name('qpool_proposedquestion_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('proposedquestion', models.ForeignKey(orm['qpool.proposedquestion'], null=False)),
            ('tag', models.ForeignKey(orm['qpool.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['proposedquestion_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'ProposedQuestion'
        db.delete_table('qpool_proposedquestion')

        # Removing M2M table for field tags on 'ProposedQuestion'
        db.delete_table(db.shorten_name('qpool_proposedquestion_tags'))
    ...
    models = {
        ...
        'qpool.proposedquestion': {
            ...
            'answers': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
