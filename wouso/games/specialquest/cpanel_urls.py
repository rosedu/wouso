...
urlpatterns = patterns('wouso.games.specialquest.cpanel',
    url(r'^$', 'home', name='specialquest_home'),
    url(r'^groups/$', 'groups', name='specialquest_cpanel_groups'),
    url(r'^group/(?P<group>\d+)/toggle/$', 'group_active_toggle', name='specialquest_cpanel_group_toggle'),
    url(r'^group/(?P<group>\d+)/destroy/$', 'group_delete', name='specialquest_cpanel_group_delete'),
    url(r'^group/(?P<group>\d+)/delete=(?P<player>\d+)$', 'group_drop_player', name='specialquest_cpanel_drop'),
