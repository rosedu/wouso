...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('quiz_quiz', (
            ...
            ('number_of_questions', self.gf('django.db.models.fields.IntegerField')(default=5)),
            ('time_limit', self.gf('django.db.models.fields.IntegerField')(default=300)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('points_reward', self.gf('django.db.models.fields.IntegerField')(default=100)),
            ('gold_reward', self.gf('django.db.models.fields.IntegerField')(default=30)),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('end', self.gf('django.db.models.fields.DateTimeField')()),
            ('another_chance', self.gf('django.db.models.fields.IntegerField')(default=7)),
        ...
        # Adding M2M table for field tags on 'Quiz'
        m2m_table_name = db.shorten_name('quiz_quiz_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('quiz', models.ForeignKey(orm['quiz.quiz'], null=False)),
            ('tag', models.ForeignKey(orm['qpool.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['quiz_id', 'tag_id'])

        # Adding model 'QuizUser'
        db.create_table('quiz_quizuser', (
            ('player_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['user.Player'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('quiz', ['QuizUser'])

        # Adding model 'UserToQuiz'
        db.create_table('quiz_usertoquiz', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quiz.QuizUser'])),
        ...
        db.send_create_signal('quiz', ['UserToQuiz'])

        # Adding M2M table for field questions on 'UserToQuiz'
        m2m_table_name = db.shorten_name('quiz_usertoquiz_questions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('usertoquiz', models.ForeignKey(orm['quiz.usertoquiz'], null=False)),
            ('question', models.ForeignKey(orm['qpool.question'], null=False))
        ))
        db.create_unique(m2m_table_name, ['usertoquiz_id', 'question_id'])

        # Adding M2M table for field attempts on 'UserToQuiz'
        m2m_table_name = db.shorten_name('quiz_usertoquiz_attempts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('usertoquiz', models.ForeignKey(orm['quiz.usertoquiz'], null=False)),
            ('quizattempt', models.ForeignKey(orm['quiz.quizattempt'], null=False))
        ))
        db.create_unique(m2m_table_name, ['usertoquiz_id', 'quizattempt_id'])

        # Adding model 'QuizAttempt'
        db.create_table('quiz_quizattempt', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('quiz', ['QuizAttempt'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field tags on 'Quiz'
        db.delete_table(db.shorten_name('quiz_quiz_tags'))

        # Deleting model 'QuizUser'
        db.delete_table('quiz_quizuser')

        # Deleting model 'UserToQuiz'
        db.delete_table('quiz_usertoquiz')

        # Removing M2M table for field questions on 'UserToQuiz'
        db.delete_table(db.shorten_name('quiz_usertoquiz_questions'))

        # Removing M2M table for field attempts on 'UserToQuiz'
        db.delete_table(db.shorten_name('quiz_usertoquiz_attempts'))

        # Deleting model 'QuizAttempt'
        db.delete_table('quiz_quizattempt')
    ...
    models = {
        ...
        'quiz.usertoquiz': {
            ...
            'attempts': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['quiz.QuizAttempt']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
