...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuizAttempt.user_to_quiz'
        db.add_column('quiz_quizattempt', 'user_to_quiz',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='attempts', null=True, to=orm['quiz.UserToQuiz']),
                      keep_default=False)

        # Adding field 'QuizAttempt.results'
        db.add_column('quiz_quizattempt', 'results',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'QuizAttempt.date'
        db.alter_column('quiz_quizattempt', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'QuizAttempt.user_to_quiz'
        db.delete_column('quiz_quizattempt', 'user_to_quiz_id')

        # Deleting field 'QuizAttempt.results'
        db.delete_column('quiz_quizattempt', 'results')


        # Changing field 'QuizAttempt.date'
        db.alter_column('quiz_quizattempt', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
