...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuizCategory'
        db.create_table('quiz_quizcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('quiz', ['QuizCategory'])

        # Adding field 'Quiz.category'
        db.add_column('quiz_quiz', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quiz.QuizCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'QuizCategory'
        db.delete_table('quiz_quizcategory')

        # Deleting field 'Quiz.category'
        db.delete_column('quiz_quiz', 'category_id')
