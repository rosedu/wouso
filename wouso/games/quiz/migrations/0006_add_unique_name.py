...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'QuizCategory', fields ['name']
        db.create_unique('quiz_quizcategory', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuizCategory', fields ['name']
        db.delete_unique('quiz_quizcategory', ['name'])
