...
def grandchalls_round_next(request):
    ...
    return render_to_response(
        'grandchallenge/cpanel/grandchallenge_round_next.html',
...
def grandchalls_round_results(request, round_number):
    ...
    return render_to_response(
        'grandchallenge/cpanel/grandchallenge_round_results.html',
        {'round': round, 'gc': GrandChallengeGame},
        context_instance=RequestContext(request))
...
def lastchalls(request):
    ...
    return render_to_response(
        'grandchallenge/cpanel/lastchalls.html',
        {'last30': last30},
        context_instance=RequestContext(request))
