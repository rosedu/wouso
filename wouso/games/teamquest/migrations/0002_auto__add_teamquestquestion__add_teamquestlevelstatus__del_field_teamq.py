...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TeamQuestStatus.highest_level'
        db.delete_column('teamquest_teamqueststatus', 'highest_level')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TeamQuestStatus.highest_level'
        db.add_column('teamquest_teamqueststatus', 'highest_level',
    ...
    models = {
        ...
        'teamquest.teamqueststatus': {
            ...
            'time_started': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 6, 0, 0)'})
        },
