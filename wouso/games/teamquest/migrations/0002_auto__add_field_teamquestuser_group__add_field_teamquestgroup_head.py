...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamQuestUser.group'
        db.add_column('teamquest_teamquestuser', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='users', null=True, blank=True, to=orm['teamquest.TeamQuestGroup']),
                      keep_default=False)

        # Adding field 'TeamQuestGroup.head'
        db.add_column('teamquest_teamquestgroup', 'head',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['teamquest.TeamQuestUser'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamQuestUser.group'
        db.delete_column('teamquest_teamquestuser', 'group_id')

        # Deleting field 'TeamQuestGroup.head'
        db.delete_column('teamquest_teamquestgroup', 'head_id')
    ...
    models = {
        ...
        'teamquest.teamquestgroup': {
            ...
            'head': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['teamquest.TeamQuestUser']", 'unique': 'True', 'null': 'True'}),
