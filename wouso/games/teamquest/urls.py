...
urlpatterns = patterns('wouso.games.teamquest.views',
    ...
    url(r'^teamhub/(?P<pk>\d+)/$', 'teamhub', name='team_hub_view'),
    ...
    url(r'^teamhub/cancel_invitation(?P<invitation_id>\d+)/$', 'setup_cancel_invitation', name='setup_cancel_invitation'),
    url(r'^teamhub/cancel_request(?P<request_id>\d+)/$', 'setup_cancel_request', name='setup_cancel_request'),
)
